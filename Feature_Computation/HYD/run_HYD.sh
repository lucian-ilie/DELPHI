#!/bin/bash
compute_HYD="python /home/j00492398/test_joey/interface-pred/workspace/compute_feature_dictionary/HYD/compute.py"

seq="/home/j00492398/test_joey/interface-pred/Dataset/DS_72/DS_72_Pid_and_Pseq.txt"
out_fn_prefix="DS_72"
${compute_HYD} ${seq} /home/j00492398/test_joey/interface-pred/Features/HYD/${out_fn_prefix}.txt
