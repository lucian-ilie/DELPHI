#!/bin/bash
compute="python /home/j00492398/test_joey/interface-pred/workspace/compute_feature_dictionary/Pro2Vec_1D/compute.py"

seq="/home/j00492398/test_joey/interface-pred/Dataset/DS_72/DS_72_Pid_and_Pseq.txt"
out_fn_prefix="DS_72"
${compute} ${seq} /home/j00492398/test_joey/interface-pred/Features/Pro2Vec_1D/${out_fn_prefix}.txt
